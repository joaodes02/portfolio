...
export default function Home() {
  ...
  const stepsTrajetoria: StepTrajetoria[] = [
    {
      ...
      subtitulo: "Desenvolvedor Full Stack • Builder",
      isIntro: true,
    },
    {
      titulo: "Curiosidade, responsabilidade e código em produção",
      subtitulo: "Quando aprender virou obrigação",
      conteudo:
        "Comecei por curiosidade, desmontando sites para entender como tudo funcionava. HTML, CSS e JavaScript foram a porta de entrada. Rapidamente saí do mundo dos tutoriais e caí na realidade do mercado: código em produção, problema real, prazo curto e impacto direto no negócio. No meio da graduação em Sistemas de Informação, me tornei pai e isso mudou completamente minha forma de encarar estudo, trabalho e evolução. Aqui aprender deixou de ser hobby e virou responsabilidade.",
      periodo: "2018 - 2021",
    },
    {
      titulo: "Stack sólida, menos hype e mais entrega",
      subtitulo: "Backend forte, frontend funcional",
      conteudo:
        "Hoje trabalho em uma empresa de desenvolvimento web atendendo múltiplos clientes e contextos diferentes. Meu dia a dia é construir e manter sistemas com Node.js, AdonisJS, PostgreSQL, React, TypeScript e boas práticas de arquitetura. Aprendi que performance, clareza de código e entendimento da regra de negócio valem mais do que qualquer modinha técnica. Stack virou ferramenta não identidade.",
      periodo: "2021 - Atual",
    },
    {
      titulo: "Construir coisas que aguentam o tempo",
      subtitulo: "Especialização contínua e visão de produto",
      conteudo:
        "Busco profundidade técnica e especialização real. Gosto de construir coisas novas, entender o problema antes da solução e criar sistemas que crescem sem quebrar. Meu foco não é apenas escrever código, mas gerar impacto, evoluir como profissional e deixar cada projeto melhor do que encontrei.",
      periodo: "Agora",
    },
  ];
  ...
  const contatoInfo: ContatoInfo[] = [
    {
      tipo: "Email",
      valor: "joaovictordes02@gmail.com",
      link: "mailto:joao@exemplo.com",
      icone: "✉️",
    },
    {
      tipo: "LinkedIn",
      valor: "/in/joão-victor-dev",
      link: "https://www.linkedin.com/in/jo%C3%A3o-victor-ribeiro-dev02/",
      icone: "💼",
    },
    {
      tipo: "GitHub",
      valor: "@joaodes02",
      link: "https://github.com/joaodes02",
      icone: "🐙",
    },
    {
      tipo: "WhatsApp",
      valor: "+55 24 99217-6690",
    ...
    if (step.isIntro) {
      return (
        <div className="flex flex-col h-full">
          <div className="">
            <h2 className="text-2xl md:text-2xl font-bold text-gray-900 dark:text-white tracking-wide leading-relaxed">
              {step.titulo}
            </h2>
  ...
  const renderStackContent = () => {
    ...
    return (
      <div className="flex flex-col h-full">
        ...
        <div className="grid grid-cols-3 md:grid-cols-3 gap-3 flex-1 content-start">
      ...
      <div className="flex flex-col h-full">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 flex-1">
          {contatoInfo.map((contato, index) => (
            ...
            >
              <div className="w-14 h-14 rounded-xl bg-linear-to-br from-blue-500 to-purple-600 flex items-center justify-center text-2xl shadow-lg group-hover:scale-110 transition-transform">
                {contato.icone}
              </div>
              <div>
        ...
        <motion.div
          ...
          animate={{ opacity: 1, y: 0 }}
          transition={{ delay: 1 }}
          className="mt-6 p-4 bg-linear-to-r from-blue-500/10 to-purple-500/10 rounded-xl border border-blue-200/50 dark:border-blue-500/20"
        >
  ...
  return (
    <div className="flex flex-col relative overflow-hidden bg-white/80 dark:bg-zinc-900/80 backdrop-blur-xl rounded-2xl shadow-2xl shadow-gray-200/50 dark:shadow-black/50 w-full max-w-4xl h-[600px] mx-auto border border-gray-200/50 dark:border-white/10">
      ...
      <div className="flex flex-col-reverse md:flex-row justify-between items-start p-4 md:p-4 pb-0 relative z-10 md:h-16">
        {/* Tabs de navegação */}
        ...
        {isTransitioning &&
          [0, 1, 2,3].map((index) => (
            <motion.div
              ...
              className="absolute top-0 h-full backdrop-blur-md bg-gray-900"
              style={{
                left: `${index * 25}%`,
                width: "25%",
                zIndex: 30,
      ...
      <div className="p-4 md:p-4 pt-0 relative z-10">
        {showNavigation && (
          <>
            {/* Indicadores de step */}
